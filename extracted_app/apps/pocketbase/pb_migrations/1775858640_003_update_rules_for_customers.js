...
migrate((app) => {
  ...
  collection.listRule = "user_id = @request.auth.id && is_deleted != true || @request.auth.role = 'super_admin'";
  collection.viewRule = "user_id = @request.auth.id && is_deleted != true || @request.auth.role = 'super_admin'";
