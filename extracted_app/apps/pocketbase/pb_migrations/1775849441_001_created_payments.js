...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "viewRule": "@request.auth.role = 'super_admin' || userId = @request.auth.id"
  });
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_4491338886");
